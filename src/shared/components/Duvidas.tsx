    ...
    return (
      <section className="infoContainerFlex d-flex flex-column p-4">
        <div className="mr-auto ml-auto w-65">
          ...
          <hr />
          <h6 onClick={() => this.toggleDuvida(1)} className="pb-3">
          ...
          <hr />
          <h6 onClick={() => this.toggleDuvida(2)} className="pb-3">
          ...
          <hr />
          <h6 onClick={() => this.toggleDuvida(3)} className="pb-3">
          ...
          <hr />
          <h6 onClick={() => this.toggleDuvida(4)} className="pb-3">
          ...
          <hr />
          <h6 onClick={() => this.toggleDuvida(5)} className="pb-3">
          ...
          <hr />
          <h6 onClick={() => this.toggleDuvida(6)} className="pb-3">
